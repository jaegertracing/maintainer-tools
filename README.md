...
| `maintainers`                | `string[]`            | Logins whose actionable PRs surface in the highest-priority trusted-author bucket for every viewer except the PR author, and whose PRs are quota-exempt. Their review or comment activity also counts as "a maintainer has engaged" for the "awaiting first response" bucket.                                                                                                                                                                  |
| `interns`                    | `string[]`            | Logins whose actionable PRs surface in the highest-priority trusted-author bucket for every viewer except the PR author, and whose PRs are quota-exempt. Unlike `maintainers`, intern activity on other PRs does NOT count as a maintainer response — put reviewer logins in `maintainers`, not here.                                                                                                                                          |
...
| --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| **Trusted authors**                                 | Author is another configured maintainer or intern. Actionable PRs remain in this highest-priority bucket after a maintainer engages.                                                                                                                | Expanded      |
